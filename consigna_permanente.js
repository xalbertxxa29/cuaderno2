document.addEventListener("DOMContentLoaded", () => {
    ...
    const consignaForm = document.getElementById("consigna-permanente-form");
    ...
    consignaForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            if (fotoFile) {
                ...
                const fotoRef = storage.ref(`consigna_permanente/${userId}_${Date.now()}`);
            ...
            alert("Consigna permanente guardada correctamente.");
            consignaForm.reset();
            ctx.clearRect(0, 0, canvas.width, canvas.height);
            hasSigned = false;
